...
|===
|Catégorie | Type alias:domaine   | Identifiant du relpart
...
a temporal attribute since for the key, and each non-key attribute stem:[a_i] with its corresponding temporal attribute stem:[ai\_since].
...
each non-key attribute stem:[a_i] with its corresponding temporal attribute stem:[a\_i\_since],
